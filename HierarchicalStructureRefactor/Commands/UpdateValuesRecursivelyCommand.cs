...
{
	/*
	 2. На вход получены: идентификатор записи и значение для позиции.
	Необходимо реализовать обновление значения поля Value всем позициям, которые являются вложенными в указанную.
